 ...
 */
export function convertApiConfigurationToProtoApiConfiguration(config) {
 ...
 */
export function convertProtoApiConfigurationToApiConfiguration(protoConfig) {
	const config = {
		// Global configuration fields (not mode-specific)
...
//# sourceMappingURL=settings-conversion.js.map
