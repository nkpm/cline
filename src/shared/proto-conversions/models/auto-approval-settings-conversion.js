...
export function convertAutoApprovalSettingsToProto(settings) {
	return {
		metadata: {},
...
export function convertProtoToAutoApprovalSettings(protoSettings) {
	return {
...
//# sourceMappingURL=auto-approval-settings-conversion.js.map
