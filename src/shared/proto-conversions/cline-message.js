 ...
 */
export function convertClineMessageToProto(message) {
	...
	let finalAskEnum = ClineAsk.FOLLOWUP // Proto default
	let finalSayEnum = ClineSay.TEXT // Proto default
	if (message.type === "ask") {
 ...
 */
export function convertProtoToClineMessage(protoMessage) {
	const message = {
		ts: protoMessage.ts,
