 ...
 */
export function createGitHubIssueUrl(baseUrl, params) {
 ...
 * @param params Map of parameter names to values for the issue form
 */
export async function createAndOpenGitHubIssue(repoOwner, repoName, issueTemplate, params) {
...
//# sourceMappingURL=github-url-utils.js.map
