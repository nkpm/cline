function calculateApiCostInternal(
	modelInfo,
	inputTokens, // Note: For OpenAI-style, this is non-cached tokens. For Anthropic-style, this is total input tokens.
	outputTokens,
	cacheCreationInputTokens,
	cacheReadInputTokens,
	totalInputTokensForPricing, // The *total* input tokens, used for tiered pricing lookup
...
export function calculateApiCostOpenAI(
	modelInfo,
	inputTokens, // For OpenAI-style, this includes cached tokens
	outputTokens,
	cacheCreationInputTokens,
	cacheReadInputTokens,
	thinkingBudgetTokens,
