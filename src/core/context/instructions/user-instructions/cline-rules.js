...
export const getGlobalClineRules = async (globalClineRulesFilePath, toggles) => {
...
export const getLocalClineRules = async (cwd, toggles) => {
	const clineRulesFilePath = path.resolve(cwd, GlobalFileNames.clineRules)
	let clineRulesFileInstructions
...
//# sourceMappingURL=cline-rules.js.map
