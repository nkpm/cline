 ...
 */
export async function refreshExternalRulesToggles(controller, workingDirectory) {
 ...
 */
export const getLocalWindsurfRules = async (cwd, toggles) => {
	const windsurfRulesFilePath = path.resolve(cwd, GlobalFileNames.windsurfRules)
	let windsurfRulesFileInstructions
...
export const getLocalCursorRules = async (cwd, toggles) => {
	...
	let cursorRulesDirInstructions
...
//# sourceMappingURL=external-rules.js.map
