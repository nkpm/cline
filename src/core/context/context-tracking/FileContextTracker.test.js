...
describe("FileContextTracker", () => {
	...
	let tracker
	let taskId
	let mockTaskMetadata
	let getTaskMetadataStub
	let saveTaskMetadataStub
	beforeEach(() => {
		...
		chokidarWatchStub = sandbox.stub(chokidar, "watch").returns(mockFileSystemWatcher)
...
//# sourceMappingURL=FileContextTracker.test.js.map
