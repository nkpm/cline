...
export class ClineIgnoreController {
	 ...
	 */
	async processIgnoreContent(content) {
	 ...
	 */
	async processClineIgnoreIncludes(content) {
		let combinedContent = ""
	 ...
	 */
	async readIncludedFile(includeLine) {
...
//# sourceMappingURL=ClineIgnoreController.js.map
