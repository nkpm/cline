const o1SystemPrompt = (systemPrompt) => `
# System Prompt
...
`
export function convertToO1Messages(openAiMessages, systemPrompt) {
...
function parseToolCall(toolName, content) {
	const tool_input = {}
...
function validateToolInput(toolName, tool_input) {
	switch (toolName) {
...
export function convertO1ResponseToAnthropicMessage(completion) {
...
//# sourceMappingURL=o1-format.js.map
