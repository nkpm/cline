 ...
 */
export function asObjectSafe(value) {
...
export function convertToVsCodeLmMessages(anthropicMessages) {
...
export function convertToAnthropicRole(vsCodeLmMessageRole) {
...
export function convertToAnthropicMessage(vsCodeLmMessage) {
