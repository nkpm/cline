...
export class VsCodeLmHandler {
	...
	async calculateTotalInputTokens(vsCodeLmMessages) {
		const messageTokens = await Promise.all(vsCodeLmMessages.map((msg) => this.countTokens(msg)))
	...
	async *createMessage(systemPrompt, messages) {
		...
		const totalInputTokens = await this.calculateTotalInputTokens(vsCodeLmMessages)
...
__decorate([withRetry()], VsCodeLmHandler.prototype, "createMessage", null)
//# sourceMappingURL=vscode-lm.js.map
