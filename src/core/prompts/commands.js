export const newTaskToolResponse = () => `<explicit_instructions type="new_task">
...
`
export const condenseToolResponse = (focusChainSettings) => `<explicit_instructions type="condense">
...
`
export const newRuleToolResponse = () => `<explicit_instructions type="new_rule">
...
`
export const reportBugToolResponse = () => `<explicit_instructions type="report_bug">
...
`
export const deepPlanningToolResponse = (focusChainSettings) => {
