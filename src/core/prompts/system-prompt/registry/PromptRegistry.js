...
export class PromptRegistry {
	 ...
	 */
	async getVersion(modelId, version, context, isNextGenModelFamily) {
		await this.load()
	 ...
	 */
	async getByTag(modelId, tag, label, context, isNextGenModelFamily) {
		await this.load()
		if (!context) {
	 ...
	 */
	registerComponent(id, componentFn) {
