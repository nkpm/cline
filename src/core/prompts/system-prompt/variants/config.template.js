...
export const config = createVariant(ModelFamily.GENERIC) // Change to your target model family
...
export const createMinimalVariant = (family) =>
...
export const createAdvancedVariant = (family) =>
	createVariant(family)
