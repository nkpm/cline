import { toolParamNames, toolUseNames } from "." // Assuming types are defined in index.ts or a similar file
 ...
 */
export function parseAssistantMessageV2(assistantMessage) {
	const contentBlocks = []
