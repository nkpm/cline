...
export async function migrateWorkspaceToGlobalStorage(context) {
...
export async function migrateMcpMarketplaceEnableSetting(mcpMarketplaceEnabledRaw) {
...
export async function migrateEnableCheckpointsSetting(enableCheckpointsSettingRaw) {
	const config = vscode.workspace.getConfiguration("cline")
...
export async function migrateCustomInstructionsToGlobalRules(context) {
	try {
...
export async function migrateLegacyApiConfigurationToModeSpecific(context) {
	try {
		...
		const planActSeparateModelsSetting = await context.globalState.get("planActSeparateModelsSetting")
...
export async function migrateWelcomeViewCompleted(context) {
	try {
