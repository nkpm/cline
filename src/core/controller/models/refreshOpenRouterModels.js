 ...
 */
export async function refreshOpenRouterModels(controller, _request) {
 ...
 */
async function readOpenRouterModels(controller) {
	const openRouterModelsFilePath = path.join(await ensureCacheDirectoryExists(controller), GlobalFileNames.openRouterModels)
...
//# sourceMappingURL=refreshOpenRouterModels.js.map
