 ...
 */
export async function refreshVercelAiGatewayModels(controller, _request) {
 ...
 */
async function readVercelAiGatewayModels(controller) {
	const vercelAiGatewayModelsFilePath = path.join(
		await ensureCacheDirectoryExists(controller),
		GlobalFileNames.vercelAiGatewayModels,
	)
...
//# sourceMappingURL=refreshVercelAiGatewayModels.js.map
