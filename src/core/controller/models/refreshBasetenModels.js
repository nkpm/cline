 ...
 */
export async function refreshBasetenModels(controller, _request) {
		...
		if (!basetenApiKey) {
			...
			if (response.data?.data) {
				...
				for (const rawModel of rawModels) {
					...
					const staticModelInfo = basetenModels[rawModel.id]
					const modelInfo = {
 ...
 */
async function readBasetenModels(controller) {
	const basetenModelsFilePath = path.join(await ensureCacheDirectoryExists(controller), GlobalFileNames.basetenModels)
...
//# sourceMappingURL=refreshBasetenModels.js.map
