...
describe("grpc-handler", () => {
	...
	let mockUnaryHandler
	let mockUnaryFailingHandler
	let mockStreamingHandler
	let mockStreamingFailingHandler
	...
	describe("handleGrpcRequest", () => {
		...
		describe("Streaming requests", () => {
			it("should handle successful streaming requests", async () => {
				...
				mockStreamingHandler.callsFake(async (_controller, _message, responseStream, _requestId) => {
		...
		describe("Concurrent requests", () => {
			it("should handle concurrent requests", async () => {
				...
				mockStreamingHandler.callsFake(async (_controller, _message, responseStream) => {
...
//# sourceMappingURL=grpc-handler.test.js.map
