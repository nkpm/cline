 ...
 */
export async function initializeWebview(controller, _request) {
	try {
		...
		featureFlagsService
			...
			.catch((err) => console.error("Failed to refresh focus chain remote flag on webview init", err))
		return Empty.create({})
	} catch (error) {
...
//# sourceMappingURL=initializeWebview.js.map
