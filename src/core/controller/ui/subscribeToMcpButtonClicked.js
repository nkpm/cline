...
const activeMcpButtonClickedSubscriptions = new Map()
/**
 ...
 */
export async function subscribeToMcpButtonClicked(controller, _request, responseStream, requestId) {
 ...
 */
export async function sendMcpButtonClickedEvent(controllerId) {
