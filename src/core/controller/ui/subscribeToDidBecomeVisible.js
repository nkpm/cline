...
const activeDidBecomeVisibleSubscriptions = new Map()
/**
 ...
 */
export async function subscribeToDidBecomeVisible(controller, _request, responseStream, requestId) {
 ...
 */
export async function sendDidBecomeVisibleEvent(controllerId) {
