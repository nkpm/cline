...
// Helper functions
function isRestrictedPath(absolutePath) {
...
function isTargetingHiddenDirectory(absolutePath) {
	const dirName = path.basename(absolutePath)
	return dirName.startsWith(".")
}
function buildIgnorePatterns(absolutePath) {
...
export async function listFiles(dirPath, recursive, limit) {
