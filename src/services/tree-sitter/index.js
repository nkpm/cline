...
export async function parseSourceCodeForDefinitionsTopLevel(dirPath, clineIgnoreController) {
...
*/
async function parseFile(filePath, languageParsers, clineIgnoreController) {
