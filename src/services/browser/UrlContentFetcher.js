import { DEFAULT_BROWSER_SETTINGS } from "@shared/BrowserSettings" // Import the interface and defaults
...
export class UrlContentFetcher {
	...
	async launchBrowser() {
		...
		const browserSettings = this.context.globalState.get("browserSettings", DEFAULT_BROWSER_SETTINGS)
