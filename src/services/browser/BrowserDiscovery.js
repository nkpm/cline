 ...
 */
export async function isPortOpen(host, port, timeout = 1000) {
 ...
 */
export async function tryConnect(ipAddress) {
	try {
 ...
 */
export async function testBrowserConnection(host) {
	try {
...
//# sourceMappingURL=BrowserDiscovery.js.map
