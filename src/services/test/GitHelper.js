 ...
 */
export async function cleanupPreviousGit(workspacePath) {
 ...
 */
export async function initializeGitRepository(workspacePath) {
 ...
 */
export async function getFileChanges(workspacePath) {
	// Validate workspace path before proceeding
	await validateWorkspacePath(workspacePath)
 ...
 */
export function calculateToolSuccessRate(toolCalls, toolFailures) {
