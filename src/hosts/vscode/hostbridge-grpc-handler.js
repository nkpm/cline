...
export class GrpcHandler {
	 ...
	 */
	async handleRequest(service, method, request, requestId, streamingCallbacks) {
		...
		const responseHandler = async (response, isLast = false, _sequenceNumber) => {
			try {
	...
	async handleUnaryRequest(service, method, request) {
	...
	getServiceHandlerConfig(serviceName) {
...
//# sourceMappingURL=hostbridge-grpc-handler.js.map
