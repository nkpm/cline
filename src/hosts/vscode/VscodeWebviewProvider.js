...
export class VscodeWebviewProvider extends WebviewProvider {
	...
	static SIDEBAR_ID = "claude-dev.SidebarProvider"
	static TAB_PANEL_ID = "claude-dev.TabPanelProvider"
	webview
	disposables = []
	...
	async handleWebviewMessage(message) {
		const postMessageToWebview = (response) => this.postMessageToWebview(response)
		switch (message.type) {
			case "grpc_request": {
...
//# sourceMappingURL=VscodeWebviewProvider.js.map
