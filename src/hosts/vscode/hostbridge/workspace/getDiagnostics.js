...
export async function getDiagnostics(_request) {
...
export function convertToFileDiagnostics(vscodeAllDiagnostics) {
	const result = []
...
export function convertVscodeDiagnostics(vscodeDiagnostics) {
	return vscodeDiagnostics.map(convertVscodeDiagnostic)
}
function convertVscodeDiagnostic(vscodeDiagnostic) {
	return {
...
function convertSeverity(vscodeSeverity) {
