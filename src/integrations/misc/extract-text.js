...
export async function detectEncoding(fileBuffer, fileExtension) {
 ...
 */
export async function callTextExtractionFunctions(filePath) {
 ...
 */
export async function processFilesIntoText(files) {
