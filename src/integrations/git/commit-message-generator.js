...
async function generate(context, scm) {
...
async function performCommitGeneration(context, gitDiff, inputBox) {
	try {
 ...
 */
export function extractCommitMessage(str) {
...
//# sourceMappingURL=commit-message-generator.js.map
